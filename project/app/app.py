        ...
        [
            ...
            dbc.Collapse(
                dbc.Nav(
                    [
                        dbc.NavItem(
                            dbc.NavLink(page["name"].title(), href=page["path"])
                        )
                        ...
                        html.Div(
                            [
                                html.A(
                                    ...
                                    href="https://github.com/michaeltoohig/vanuatu-energy-dash-app",
                                ),
                            ],
...
app.layout = dbc.Container(
    [
        ...
        dbc.Container(
            ...
            fluid=False,
            className="mt-3",
            style={"min-height": "calc(100vh - 245px)"},
        ),
        footer,
    ],
    fluid=True,
    className="px-0 background-gradient",
)
